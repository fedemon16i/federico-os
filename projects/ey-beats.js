(function (w) {
  ...
  function run(name) {
    var all = {
      measure: { skin:'ey', device:'desktop', cursors:0, screens:S, steps:[
      ...
      analyze: { skin:'ey', device:'desktop', cursors:3, screens:S, steps:[
      ...
      funnel: { skin:'ey', device:'desktop', cursors:0, screens:S, steps:[
      ...
      research: { skin:'ey', device:'desktop', cursors:0, screens:S, steps:[
      ...
      requester: { skin:'ey', device:'desktop', cursors:1, screens:S, steps:[
        { screen:'catalog.services', say:'The after starts on the card — requirements before Get started.' },
        { ring:1, to:'#info' },
        { tap:1, to:'#info' },
      ...
      publisher: { skin:'ey', device:'desktop', cursors:1, screens:S, steps:[
        { screen:'pub.queue', say:'Publishers start in the queue, not on a blank form.' },
        { ring:1, to:'#go' },
        { tap:1, to:'#go' },
        { screen:'pub.type', say:'Pick the shape first. Service is the request path.' },
        { ring:1, to:'#go' },
        { tap:1, to:'#go' },
        { screen:'pub.fields', say:'Load a file or add a field by hand.' },
        { tap:1, to:'#go' },
